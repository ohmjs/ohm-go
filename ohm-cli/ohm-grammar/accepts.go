...
func (node *LexCaseName[P, R]) AcceptAlt3(visitor any, payload P) (result R, err error) {
	// Node
	{
		if v, ok := visitor.(goohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				goohm.WalkCstCallTermAndSpace(node.Alt3, fnTerm, fnSpaceBefore)
			}
		}
	}
	return
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit5(visitor any, payload P) (result R, err error) {
	...
	if len(node.HexDigit5.Children()) > 0 {
		...
		if v, ok := visitor.(goohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				goohm.WalkCstCallTermAndSpace(node.HexDigit5, fnTerm, fnSpaceBefore)
			}
		}
	}
	return
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit6(visitor any, payload P) (result R, err error) {
	...
	if len(node.HexDigit6.Children()) > 0 {
		...
		if v, ok := visitor.(goohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				goohm.WalkCstCallTermAndSpace(node.HexDigit6, fnTerm, fnSpaceBefore)
			}
		}
	}
	return
...
func (node *LexToken[P, R]) AcceptRule(visitor any, payload P) (result R, err error) {
	...
	case "any":
		...
		if v, ok := visitor.(goohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				goohm.WalkCstCallTermAndSpace(node.Rule, fnTerm, fnSpaceBefore)
			}
		}
	default:
