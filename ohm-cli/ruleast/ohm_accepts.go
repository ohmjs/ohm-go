...
// Grammars
// = Grammar*
func (node *Grammars[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Grammars")
	...
	ohm.TypeCheckMethod[P, R](visitor, "Grammars")
...
func (node *Grammar[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Grammar")
	...
	ohm.TypeCheckMethod[P, R](visitor, "Grammar")
	return node.DefaultAccept(visitor, payload)
}

func (node *Grammar[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptIdent(visitor, payload)
...
func (node *Grammar[P, R]) AcceptIdent(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Ident.Children()
	result, err = (&LexIdent[P, R]{
		Name: kids[0].(ohm.RuleNode),
...
func (node *Grammar[P, R]) AcceptSuperGrammar(visitor any, payload P) (result R, err error) {
	...
	if len(node.SuperGrammar.Children()) > 0 {
		...
		result, err = (&SuperGrammar[P, R]{
			...
			Ident: kids[1].(ohm.RuleNode),
		}).Accept(n, visitor, payload)
	}
	return
}

func (node *Grammar[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
...
func (node *Grammar[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
...
// SuperGrammar
// = "<:" ident
func (node *SuperGrammar[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "SuperGrammar")
	...
	ohm.TypeCheckMethod[P, R](visitor, "SuperGrammar")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *SuperGrammar[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
...
func (node *SuperGrammar[P, R]) AcceptIdent(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Ident.Children()
	result, err = (&LexIdent[P, R]{
		Name: kids[0].(ohm.RuleNode),
...
func (node *RuleDefine[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Rule_define")
	...
	ohm.TypeCheckMethod[P, R](visitor, "RuleDefine")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *RuleDefine[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	...
	result, err = node.AcceptRuleDescr(visitor, payload)
	result, err = node.AcceptTerm(visitor, payload)
	result, err = node.AcceptRuleBody(visitor, payload)
	return
}

func (node *RuleDefine[P, R]) AcceptIdent(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Ident.Children()
	result, err = (&LexIdent[P, R]{
		Name: kids[0].(ohm.RuleNode),
...
func (node *RuleDefine[P, R]) AcceptRuleDescr(visitor any, payload P) (result R, err error) {
	// Opt
...
func (node *RuleDefine[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *RuleOverride[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Rule_override")
	...
	ohm.TypeCheckMethod[P, R](visitor, "RuleOverride")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *RuleOverride[P, R]) AcceptIdent(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Ident.Children()
	result, err = (&LexIdent[P, R]{
		Name: kids[0].(ohm.RuleNode),
...
func (node *RuleOverride[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *RuleExtend[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Rule_extend")
	...
	ohm.TypeCheckMethod[P, R](visitor, "RuleExtend")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *RuleExtend[P, R]) AcceptIdent(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Ident.Children()
	result, err = (&LexIdent[P, R]{
		Name: kids[0].(ohm.RuleNode),
...
func (node *RuleExtend[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *RuleBody[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "RuleBody")
	...
	ohm.TypeCheckMethod[P, R](visitor, "RuleBody")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *RuleBody[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Opt
...
//
// Seq caseName
func (node *TopLevelTermInline[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "TopLevelTerm_inline")
	...
	ohm.TypeCheckMethod[P, R](visitor, "TopLevelTermInline")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *TopLevelTermInline[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	...
	result, err = node.AcceptCaseName(visitor, payload)
	return
}
...
func (node *TopLevelTermInline[P, R]) AcceptCaseName(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.CaseName.Children()
	result, err = (&LexCaseName[P, R]{
		Term: kids[0].(ohm.TerminalNode),
		Alt1: kids[1].(ohm.ListNode),
		Name: kids[2].(ohm.RuleNode),
		Alt2: kids[3].(ohm.ListNode),
		Alt3: kids[4],
...
func (node *OverrideRuleBody[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "OverrideRuleBody")
	...
	ohm.TypeCheckMethod[P, R](visitor, "OverrideRuleBody")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *OverrideRuleBody[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Opt
	if len(node.Term.Children()) > 0 {
		n := node.Term.Children()[0]
		if v, ok := visitor.(ohm.TerminalVisitor); ok {
...
//
// "..."
func (node *OverrideTopLevelTermSuperSplice[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "OverrideTopLevelTerm_superSplice")
	...
	ohm.TypeCheckMethod[P, R](visitor, "OverrideTopLevelTermSuperSplice")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *OverrideTopLevelTermSuperSplice[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
// Formals
// = "<" ListOf<ident, ","> ">"
func (node *Formals[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Formals")
	...
	ohm.TypeCheckMethod[P, R](visitor, "Formals")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *Formals[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *Formals[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
// Params
// = "<" ListOf<Seq, ","> ">"
func (node *Params[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Params")
	...
	ohm.TypeCheckMethod[P, R](visitor, "Params")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *Params[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *Params[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
// Alt
// = NonemptyListOf<Seq, "|">
func (node *Alt[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Alt")
	...
	ohm.TypeCheckMethod[P, R](visitor, "Alt")
	return node.DefaultAccept(visitor, payload)
}
...
// Seq
// = Iter*
func (node *Seq[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Seq")
	...
	ohm.TypeCheckMethod[P, R](visitor, "Seq")
	return node.DefaultAccept(visitor, payload)
}
...
//
// Pred "*"
func (node *IterStar[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Iter_star")
	...
	ohm.TypeCheckMethod[P, R](visitor, "IterStar")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *IterStar[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// Pred "+"
func (node *IterPlus[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Iter_plus")
	...
	ohm.TypeCheckMethod[P, R](visitor, "IterPlus")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *IterPlus[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// Pred "?"
func (node *IterOpt[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Iter_opt")
	...
	ohm.TypeCheckMethod[P, R](visitor, "IterOpt")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *IterOpt[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "~" Lex
func (node *PredNot[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Pred_not")
	...
	ohm.TypeCheckMethod[P, R](visitor, "PredNot")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *PredNot[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "&" Lex
func (node *PredLookahead[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Pred_lookahead")
	...
	ohm.TypeCheckMethod[P, R](visitor, "PredLookahead")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *PredLookahead[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "#" Base
func (node *LexLex[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Lex_lex")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexLex")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexLex[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *BaseApplication[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Base_application")
	...
	ohm.TypeCheckMethod[P, R](visitor, "BaseApplication")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *BaseApplication[P, R]) AcceptIdent(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Ident.Children()
	result, err = (&LexIdent[P, R]{
		Name: kids[0].(ohm.RuleNode),
...
func (node *BaseRange[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Base_range")
	...
	ohm.TypeCheckMethod[P, R](visitor, "BaseRange")
	return node.DefaultAccept(visitor, payload)
}

func (node *BaseRange[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptOneCharTerminal1(visitor, payload)
	result, err = node.AcceptTerm(visitor, payload)
	result, err = node.AcceptOneCharTerminal2(visitor, payload)
	return
}

func (node *BaseRange[P, R]) AcceptOneCharTerminal1(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.OneCharTerminal1.Children()
	result, err = (&LexOneCharTerminal[P, R]{
		Term1:        kids[0].(ohm.TerminalNode),
		TerminalChar: kids[1].(ohm.RuleNode),
		Term2:        kids[2].(ohm.TerminalNode),
	}).Accept(node.OneCharTerminal1, visitor, payload)
	return
}

func (node *BaseRange[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *BaseRange[P, R]) AcceptOneCharTerminal2(visitor any, payload P) (result R, err error) {
	// Rule
...
//
// terminal
func (node *BaseTerminal[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Base_terminal")
	...
	ohm.TypeCheckMethod[P, R](visitor, "BaseTerminal")
	return node.DefaultAccept(visitor, payload)
}

func (node *BaseTerminal[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptTerminal(visitor, payload)
	return
}

func (node *BaseTerminal[P, R]) AcceptTerminal(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Terminal.Children()
	result, err = (&LexTerminal[P, R]{
		Term1:        kids[0].(ohm.TerminalNode),
		TerminalChar: kids[1].(ohm.ListNode),
		Term2:        kids[2].(ohm.TerminalNode),
...
//
// "(" Alt ")"
func (node *BaseParen[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "Base_paren")
	...
	ohm.TypeCheckMethod[P, R](visitor, "BaseParen")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *BaseParen[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *BaseParen[P, R]) AcceptAlt(visitor any, payload P) (result R, err error) {
	...
	result, err = (&Alt[P, R]{
		NonemptyListOf: kids[0].(ohm.BHorNode),
	}).Accept(node.Alt, visitor, payload)
	return
}

func (node *BaseParen[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
// = "(" ruleDescrText ")"
func (node *LexRuleDescr[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "ruleDescr")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexRuleDescr")
	return node.DefaultAccept(visitor, payload)
}

func (node *LexRuleDescr[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptTerm1(visitor, payload)
	result, err = node.AcceptRuleDescrText(visitor, payload)
	result, err = node.AcceptTerm2(visitor, payload)
	return
}

func (node *LexRuleDescr[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *LexRuleDescr[P, R]) AcceptRuleDescrText(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.RuleDescrText.Children()
	result, err = (&LexRuleDescrText[P, R]{
		Alt: kids[0].(ohm.ListNode),
	}).Accept(node.RuleDescrText, visitor, payload)
	return
}

func (node *LexRuleDescr[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
// ruleDescrText
// = (~")" any)*
func (node *LexRuleDescrText[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "ruleDescrText")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexRuleDescrText")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexRuleDescrText[P, R]) AcceptAlt(visitor any, payload P) (result R, err error) {
...
// caseName
// = "--" (~"\n" space)* name (~"\n" space)* ("\n" | &"}")
func (node *LexCaseName[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "caseName")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexCaseName")
	return node.DefaultAccept(visitor, payload)
}

func (node *LexCaseName[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptTerm(visitor, payload)
	result, err = node.AcceptAlt1(visitor, payload)
	result, err = node.AcceptName(visitor, payload)
	result, err = node.AcceptAlt2(visitor, payload)
	result, err = node.AcceptAlt3(visitor, payload)
	return
}

func (node *LexCaseName[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *LexCaseName[P, R]) AcceptAlt1(visitor any, payload P) (result R, err error) {
...
func (node *LexCaseName[P, R]) AcceptName(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Name.Children()
	result, err = (&LexName[P, R]{
		NameFirst: kids[0].(ohm.RuleNode),
		NameRest:  kids[1].(ohm.ListNode),
	}).Accept(node.Name, visitor, payload)
	return
}

func (node *LexCaseName[P, R]) AcceptAlt2(visitor any, payload P) (result R, err error) {
...
func (node *LexCaseName[P, R]) AcceptAlt3(visitor any, payload P) (result R, err error) {
	// Node
	{
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			v.NodeVisit(node.Alt3)
		} else {
			var (
				fnTerm        func(node ohm.TerminalNode)
				fnSpaceBefore func(spaces string)
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				ohm.WalkCstCallTermAndSpace(node.Alt3, fnTerm, fnSpaceBefore)
			}
		}
	}
	return
...
// name  (a name)
// = nameFirst nameRest*
func (node *LexName[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "name")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexName")
	return node.DefaultAccept(visitor, payload)
}

func (node *LexName[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptNameFirst(visitor, payload)
	result, err = node.AcceptNameRest(visitor, payload)
	return
}

func (node *LexName[P, R]) AcceptNameFirst(visitor any, payload P) (result R, err error) {
	// Rule
...
func (node *LexName[P, R]) AcceptNameRest(visitor any, payload P) (result R, err error) {
...
// = "_"
// | letter
func (node *LexNameFirst[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "nameFirst")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexNameFirst")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexNameFirst[P, R]) AcceptArg(visitor any, payload P) (result R, err error) {
	// Node
	{
		if v, ok := visitor.(ohm.NodeVisitor); ok {
...
// = "_"
// | alnum
func (node *LexNameRest[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "nameRest")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexNameRest")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexNameRest[P, R]) AcceptArg(visitor any, payload P) (result R, err error) {
	// Node
	{
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			v.NodeVisit(node.Arg)
...
// ident  (an identifier)
// = name
func (node *LexIdent[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "ident")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexIdent")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexIdent[P, R]) AcceptName(visitor any, payload P) (result R, err error) {
	// Rule
	kids := node.Name.Children()
	result, err = (&LexName[P, R]{
		NameFirst: kids[0].(ohm.RuleNode),
...
// terminal
// = "\"" terminalChar* "\""
func (node *LexTerminal[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "terminal")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexTerminal")
	return node.DefaultAccept(visitor, payload)
}

func (node *LexTerminal[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptTerm1(visitor, payload)
	result, err = node.AcceptTerminalChar(visitor, payload)
	result, err = node.AcceptTerm2(visitor, payload)
	return
}

func (node *LexTerminal[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *LexTerminal[P, R]) AcceptTerminalChar(visitor any, payload P) (result R, err error) {
...
func (node *LexTerminal[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
// oneCharTerminal
// = "\"" terminalChar "\""
func (node *LexOneCharTerminal[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "oneCharTerminal")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexOneCharTerminal")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexOneCharTerminal[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *LexOneCharTerminal[P, R]) AcceptTerminalChar(visitor any, payload P) (result R, err error) {
	// Rule
...
func (node *LexOneCharTerminal[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
// = escapeChar
// | ~"\\" ~"\"" ~"\n" "\u{0}".."\u{10FFFF}"
func (node *LexTerminalChar[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "terminalChar")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexTerminalChar")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexTerminalChar[P, R]) AcceptArg(visitor any, payload P) (result R, err error) {
	// Node
	{
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			v.NodeVisit(node.Arg)
...
func (node *LexEscapeChar[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	...
	case "escapeChar_unicodeCodePoint":
		...
		return (&LexEscapeCharUnicodeCodePoint[P, R]{
			...
			HexDigit2: kids[2].(ohm.OptNode),
			HexDigit3: kids[3].(ohm.OptNode),
			HexDigit4: kids[4].(ohm.OptNode),
			HexDigit5: kids[5].(ohm.OptNode),
			HexDigit6: kids[6].(ohm.OptNode),
			Term2:     kids[7].(ohm.TerminalNode),
		}).Accept(node.Node, visitor, payload)
...
//
// "\\\\"
func (node *LexEscapeCharBackslash[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_backslash")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharBackslash")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharBackslash[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "\\\""
func (node *LexEscapeCharDoubleQuote[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_doubleQuote")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharDoubleQuote")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharDoubleQuote[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "\\\'"
func (node *LexEscapeCharSingleQuote[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_singleQuote")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharSingleQuote")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharSingleQuote[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "\\b"
func (node *LexEscapeCharBackspace[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_backspace")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharBackspace")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharBackspace[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "\\n"
func (node *LexEscapeCharLineFeed[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_lineFeed")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharLineFeed")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharLineFeed[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "\\r"
func (node *LexEscapeCharCarriageReturn[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_carriageReturn")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharCarriageReturn")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharCarriageReturn[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// "\\t"
func (node *LexEscapeCharTab[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_tab")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharTab")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharTab[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_unicodeCodePoint")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharUnicodeCodePoint")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	...
	result, err = node.AcceptHexDigit5(visitor, payload)
	result, err = node.AcceptHexDigit6(visitor, payload)
	result, err = node.AcceptTerm2(visitor, payload)
	return
}

func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit1(visitor any, payload P) (result R, err error) {
	// Rule
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit2(visitor any, payload P) (result R, err error) {
	// Opt
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit3(visitor any, payload P) (result R, err error) {
	// Opt
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit4(visitor any, payload P) (result R, err error) {
	// Opt
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit5(visitor any, payload P) (result R, err error) {
	// Opt
	if len(node.HexDigit5.Children()) > 0 {
		...
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				ohm.WalkCstCallTermAndSpace(node.HexDigit5, fnTerm, fnSpaceBefore)
			}
		}
	}
	return
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptHexDigit6(visitor any, payload P) (result R, err error) {
	// Opt
	if len(node.HexDigit6.Children()) > 0 {
		...
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				ohm.WalkCstCallTermAndSpace(node.HexDigit6, fnTerm, fnSpaceBefore)
			}
		}
	}
	return
...
func (node *LexEscapeCharUnicodeCodePoint[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
func (node *LexEscapeCharUnicodeEscape[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_unicodeEscape")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharUnicodeEscape")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharUnicodeEscape[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *LexEscapeCharUnicodeEscape[P, R]) AcceptHexDigit1(visitor any, payload P) (result R, err error) {
	// Rule
	// "unknown rule hexDigit"
	if v, ok := visitor.(ohm.NodeVisitor); ok {
		v.NodeVisit(node.HexDigit1)
...
func (node *LexEscapeCharUnicodeEscape[P, R]) AcceptHexDigit2(visitor any, payload P) (result R, err error) {
	// Rule
	// "unknown rule hexDigit"
	if v, ok := visitor.(ohm.NodeVisitor); ok {
...
func (node *LexEscapeCharUnicodeEscape[P, R]) AcceptHexDigit3(visitor any, payload P) (result R, err error) {
	// Rule
	// "unknown rule hexDigit"
	if v, ok := visitor.(ohm.NodeVisitor); ok {
...
func (node *LexEscapeCharUnicodeEscape[P, R]) AcceptHexDigit4(visitor any, payload P) (result R, err error) {
	// Rule
	// "unknown rule hexDigit"
	if v, ok := visitor.(ohm.NodeVisitor); ok {
...
//
// "\\x" hexDigit hexDigit
func (node *LexEscapeCharHexEscape[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "escapeChar_hexEscape")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexEscapeCharHexEscape")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexEscapeCharHexEscape[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *LexEscapeCharHexEscape[P, R]) AcceptHexDigit1(visitor any, payload P) (result R, err error) {
	// Rule
	// "unknown rule hexDigit"
	if v, ok := visitor.(ohm.NodeVisitor); ok {
		v.NodeVisit(node.HexDigit1)
...
func (node *LexEscapeCharHexEscape[P, R]) AcceptHexDigit2(visitor any, payload P) (result R, err error) {
	// Rule
	// "unknown rule hexDigit"
	if v, ok := visitor.(ohm.NodeVisitor); ok {
		v.NodeVisit(node.HexDigit2)
...
func (node *LexSpace[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptComment(visitor, payload)
	return
}

func (node *LexSpace[P, R]) AcceptComment(visitor any, payload P) (result R, err error) {
	// Rule
...
//
// "//" (~"\n" any)* &("\n" | end)
func (node *LexCommentSingleLine[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "comment_singleLine")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexCommentSingleLine")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexCommentSingleLine[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
func (node *LexCommentSingleLine[P, R]) AcceptAlt(visitor any, payload P) (result R, err error) {
	for _, n := range node.Alt.Children() {
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			v.NodeVisit(n)
		} else {
...
//
// "/*" (~"*/" any)* "*/"
func (node *LexCommentMultiLine[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "comment_multiLine")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexCommentMultiLine")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexCommentMultiLine[P, R]) AcceptTerm1(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term1)
	}
...
func (node *LexCommentMultiLine[P, R]) AcceptAlt(visitor any, payload P) (result R, err error) {
	for _, n := range node.Alt.Children() {
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			v.NodeVisit(n)
		} else {
...
func (node *LexCommentMultiLine[P, R]) AcceptTerm2(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term2)
	}
...
//
// tokens = token*
func (node *LexTokens[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "tokens")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexTokens")
	return node.DefaultAccept(visitor, payload)
}

func (node *LexTokens[P, R]) DefaultAccept(visitor any, payload P) (result R, err error) {
	result, err = node.AcceptToken(visitor, payload)
	return
}

func (node *LexTokens[P, R]) AcceptToken(visitor any, payload P) (result R, err error) {
...
func (node *LexToken[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "token")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexToken")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexToken[P, R]) AcceptRule(visitor any, payload P) (result R, err error) {
	...
	case "operator":
		kids := node.Rule.Children()
		result, err = (&LexOperator[P, R]{
			Term: kids[0].(ohm.TerminalNode),
		}).Accept(node.Rule, visitor, payload)
	case "punctuation":
		kids := node.Rule.Children()
		result, err = (&LexPunctuation[P, R]{
			Term: kids[0].(ohm.TerminalNode),
		}).Accept(node.Rule, visitor, payload)
	case "terminal":
		kids := node.Rule.Children()
	...
	case "any":
		...
		if v, ok := visitor.(ohm.NodeVisitor); ok {
			...
			if fnTerm != nil || fnSpaceBefore != nil {
				ohm.WalkCstCallTermAndSpace(node.Rule, fnTerm, fnSpaceBefore)
			}
		}
	default:
...
//
// operator = "<:" | "=" | ":=" | "+=" | "*" | "+" | "?" | "~" | "&"
func (node *LexOperator[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "operator")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexOperator")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexOperator[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
...
//
// punctuation = "<" | ">" | "," | "--"
func (node *LexPunctuation[P, R]) Accept(this ohm.Node, visitor any, payload P) (result R, err error) {
	ohm.AssertName(this, "punctuation")
	...
	ohm.TypeCheckMethod[P, R](visitor, "LexPunctuation")
	return node.DefaultAccept(visitor, payload)
}
...
func (node *LexPunctuation[P, R]) AcceptTerm(visitor any, payload P) (result R, err error) {
	// Term
	if v, ok := visitor.(ohm.TerminalVisitor); ok {
		v.Terminal(node.Term)
	}
